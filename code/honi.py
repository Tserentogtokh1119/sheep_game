...
class SheepCollectGame:
    def __init__(self):
        ...
        try:
            self.background = pygame.image.load('./env/grass.png').convert()
        ...
        try:
            self.yurt = pygame.image.load('./env/ger.png').convert_alpha()
        ...
        try:
            self.fence = pygame.image.load('./env/hashaa.png').convert_alpha()
        ...
        try:
            sheep_img = pygame.image.load('./env/honi.png').convert_alpha()
        ...
        try:
            player1_img = pygame.image.load('./env/huu.png').convert_alpha()
        ...
        try:
            player2_img = pygame.image.load('./env/ohin.png').convert_alpha()
